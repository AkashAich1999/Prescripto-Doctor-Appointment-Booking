...
const NavBar = () => {
  ...
  return (
    <div className="flex justify-between items-center py-4 text-sm border-b border-b-gray-400 mb-5">
        ...
        <ul className="hidden md:flex gap-5 items-start font-medium">
            <NavLink to="/">
                ...
                <hr className="border-none outline-none h-0.5 w-3/5 bg-primary m-auto hidden" /> {/** hidden means display: none */}
            </NavLink>
            <NavLink to="/doctors">
        ...
        <div className="flex items-center gap-4">
            ...
            {/* ---------- Mobile Menu ---------- */}
            <div className={`${showMenu ? "fixed w-full" : "h-0 w-0"} bg-white md:hidden right-0 top-0 bottom-0 z-20 overflow-hidden transition-all`}>
